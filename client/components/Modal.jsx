  ...
  return (
    <Transition.Root show={isOpen} as={Fragment}>
      <Dialog as="div" className="fixed z-50 inset-0 pt-8" onClose={setIsOpen}>
        <div className="flex flex-col items-center justify-start min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:p-0">
          <Transition.Child
            as={Fragment}
          ...
          >
            {/* Modal wrapper */}
            <div className="inline-block align-bottom bg-black rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:mt-10 sm:align-middle sm:max-w-xl sm:w-full">
              {/* Modal content */}
